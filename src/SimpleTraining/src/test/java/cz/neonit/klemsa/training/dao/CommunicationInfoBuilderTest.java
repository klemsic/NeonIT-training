...
public class CommunicationInfoBuilderTest {
    ...
    public void buildFromJson_Null() {
        CommunicationInfo c = CommunicationInfoParser.parse(null);
        assertNull(c);
    }

    @Test
    public void buildFromJson_Empty() {
        CommunicationInfo c = CommunicationInfoParser.parse("");
        assertNull(c);
    }

    @Test
    public void buildFromJson_CorrectCallString() {
        CommunicationInfo c1 = CommunicationInfoParser.parse("{\"message_type\": \"CALL\",\"timestamp\": 1517732102," +
    ...
    public void buildFromJson_CorrectMessageString() {
        CommunicationInfo c1 = CommunicationInfoParser.parse("{\"message_type\": \"MSG\",\"timestamp\": 1517559360," +
    ...
    public void buildFromJson_InvalidMessageType() {
        CommunicationInfo c = CommunicationInfoParser.parse("{\"message_type\": \"XXX\",\"timestamp\": 1517559360," +
                "\"origin\": 49151123456,\"destination\": 49151123789,\"message_content\": \"1. HELLO\"}");
        assertNull(c);
    }
    ...
    public void buildFromJson_NoMessageType() {
        CommunicationInfo c = CommunicationInfoParser.parse("{\"timestamp\": 1517559360," +
                "\"origin\": 49151123456,\"destination\": 49151123789,\"message_content\": \"1. HELLO\"}");
        assertNull(c);
    }
    ...
    public void buildFromJson_NotJson() {
        CommunicationInfo c = CommunicationInfoParser.parse("abcdefgh");
        assertNull(c);
    }
}
